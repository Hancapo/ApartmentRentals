        ...
        public List<Departamento> GetDepartamentoList()
        {
            ...
            foreach (DataRow dr in osc.OracleToDataTable(sqlcommand).Rows)
            {
                Departamento dede = new()
                {
                    ...
                    FotoSmall = ToImage((byte[])dr["FotoSmall"]),
